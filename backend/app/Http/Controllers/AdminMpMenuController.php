<?php namespace App\Http\Controllers;
	...
	class AdminMpMenuController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Menu Padre","name"=>"menu_padre","join"=>"mp_menu,nombre"];
			$this->col[] = ["label"=>"Estado","name"=>"estado"];
			$this->col[] = ["label"=>"Orden","name"=>"orden"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nombre','name'=>'nombre','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Icono','name'=>'icono','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$fontawesome = Fontawesome::getIcons();
	        $custom = view('crudbooster::components.list_icon', compact('fontawesome', '$row->icon'))->render();
	        $this->form[] = ['label' => 'Icono', 'name' => 'icono', 'type' => 'custom', 'html' => $custom, 'required' => true];
			$this->form[] = ['label'=>'Menu Padre','name'=>'menu_padre','type'=>'select2','validation'=>'','width'=>'col-sm-10','datatable'=>'mp_menu,nombre'];
			$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Orden','name'=>'orden','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Orden","name"=>"orden","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
