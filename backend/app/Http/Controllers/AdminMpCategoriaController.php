<?php namespace App\Http\Controllers;
	...
	class AdminMpCategoriaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'select2','validation'=>'required','width'=>'col-sm-10'];
